# Baseball Glove Dataset (2700 images YOLO format
...
- Clear images
- Completely labeled
- Suitable for training baseball glove object detection models
- Directly usable
- Convenient and effortless.

Please send the link to the download cloud drive, and are not refundable .
